...
describe CmbPay::Sign::RC4 do
  ...
  describe '#encrypt' do
    specify 'RC4 encrypt should same as cmbJava.jar result' do
      ...
      encrypted = subject.encrypt(strkey_md5_digest, input)
      ...
      expect(CmbPay::Sign::Base64.encode64(encrypted)).to eq 'aGpDsEcbmOuYcSeT5rQhnl0Z18OKkuAJlvDJXaex3KJXCn7KJ9XYfiw*UhIW6/a*YRTH1ImLwYPMybevPLIOUx1y6WdEnfv84loW9JF8nvw3Hsv/IWQpLd80SawuxobNab5OMOxpLg=='
    end
  end
end
